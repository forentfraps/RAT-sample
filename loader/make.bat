...
gcc -o loader.exe loader.c aes.o fast.o tricks.o windows_intern.o dynamic_strings.o ico.res info.res -nostartfiles -static -lgdiplus -Wl,-e WinMainCRTStartup
