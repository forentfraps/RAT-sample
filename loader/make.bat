...
gcc -o loader.exe loader.c aes.o fast.o tricks.o windows_intern.o ico.res info.res -Wpointer-to-int-cast -nostartfiles -static -lgdiplus -Wl,-e WinMainCRTStartup 
